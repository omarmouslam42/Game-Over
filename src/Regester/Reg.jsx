            ...
            <div className='col-md-6 game-over-content log-content '>
              <div className='py-4'>
                <form onSubmit={submitUser}>
                    ...
                    <p className='text-center text-muted'>Already a member? <Link to="/login" className='text-decoration-none text-primary'>  Log In <i class="fa-solid fa-chevron-right fa-xs"></i></Link></p>
                </form>
              </div>
            </div>
        </div>
